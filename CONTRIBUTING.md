...
The project maintains **12 open issues** — see [`.github/issue-bodies/README.md`](.github/issue-bodies/README.md) for the canonical backlog. Closed issues remain for history; do not reopen without triage.
